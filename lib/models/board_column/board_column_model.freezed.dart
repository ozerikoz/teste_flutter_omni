...
mixin _$BoardColumnModel {
  ...
  $BoardColumnModelCopyWith<BoardColumnModel> get copyWith =>
      _$BoardColumnModelCopyWithImpl<BoardColumnModel>(
          this as BoardColumnModel, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, const DeepCollectionEquality().hash(tasks));
...
abstract mixin class $BoardColumnModelCopyWith<$Res> {
  factory $BoardColumnModelCopyWith(
          BoardColumnModel value, $Res Function(BoardColumnModel) _then) =
      _$BoardColumnModelCopyWithImpl;
  @useResult
...
class _BoardColumnModel implements BoardColumnModel {
  const _BoardColumnModel(
      {required this.id,
      required this.title,
      required final List<TaskModel> tasks})
      : _tasks = tasks;
  factory _BoardColumnModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BoardColumnModelCopyWith<_BoardColumnModel> get copyWith =>
      __$BoardColumnModelCopyWithImpl<_BoardColumnModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$BoardColumnModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$BoardColumnModelCopyWith<$Res>
    implements $BoardColumnModelCopyWith<$Res> {
  factory _$BoardColumnModelCopyWith(
          _BoardColumnModel value, $Res Function(_BoardColumnModel) _then) =
      __$BoardColumnModelCopyWithImpl;
  @override
  @useResult
  $Res call({String id, String title, List<TaskModel> tasks});
}
